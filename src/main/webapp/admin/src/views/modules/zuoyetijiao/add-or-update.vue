<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.tijiaozuoye" label="提交作业" prop="tijiaozuoye">
          <file-upload
          tip="点击上传提交作业"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tijiaozuoye" label="提交作业" prop="tijiaozuoye">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.tijiaozuoye)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
