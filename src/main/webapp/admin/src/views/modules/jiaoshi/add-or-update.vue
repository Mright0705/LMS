    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="个人介绍" prop="gerenjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gerenjieshao" label="个人介绍" prop="gerenjieshao">
                    <span v-html="ruleForm.gerenjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gerenjieshao = this.ruleForm.gerenjieshao.replace(reg,'../../../ssmlu7no/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
