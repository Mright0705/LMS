    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课程详情" prop="kechengjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengjieshao" label="课程详情" prop="kechengjieshao">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../ssmlu7no/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
