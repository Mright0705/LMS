<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.zuoyewenjian" label="作业文件" prop="zuoyewenjian">
          <file-upload
          tip="点击上传作业文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyewenjian" label="作业文件" prop="zuoyewenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.zuoyewenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="完成日期" prop="wanchengriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.wanchengriqi" 
                type="date"
                :readonly="ro.wanchengriqi"
                placeholder="完成日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wanchengriqi" label="完成日期" prop="wanchengriqi">
              <el-input v-model="ruleForm.wanchengriqi" 
                placeholder="完成日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyeyaoqiu" label="作业要求" prop="zuoyeyaoqiu">
                    <span>{{ruleForm.zuoyeyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
